function DragImgUpload(id, options) {
	...
	var imgurl = options.imgurl? options.imgurl : '/assets/images/upload.png';
	this.preview = $('<div id="preview"><img src="'+imgurl+'" class="img-responsive"  style="width: 100%;height: auto;" alt="" title=""> </div>');
...
DragImgUpload.prototype = {
	...
	onChangeUploadFile : function() {
		...
		if (window.URL.createObjectURL) {
			...
			this.me.find("img").attr("alt", filename);
			if (this.callback) {
				this.callback(files);
			}
		}
